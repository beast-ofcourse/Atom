...
- [[providerNeedsKey()]] `INFERRED`
- [[applyBeforeCompact()]] `INFERRED`
- [[requestCompactSummary()]] `INFERRED`
- [[compactPct()]] `INFERRED`
- [[localUnreachableNotice()]] `EXTRACTED`
