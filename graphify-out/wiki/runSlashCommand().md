...
> God node · 78 connections · [C:\Users\Bhavin\Videos\WEB dev\Opensource porjects\Atom\src\web\ui\app.js](file:///C:/Users/Bhavin/Videos/WEB%20dev/Opensource%20porjects/Atom/src/web/ui/app.js#L2067)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as runSlashCommand()
...
- [[getSession()]] `INFERRED`
- [[pushInfo()]] `EXTRACTED`
- [[selectSession()]] `EXTRACTED`
- [[runReloadCommand()]] `EXTRACTED`
- [[createSession()]] `INFERRED`
- [[json]] `INFERRED`
- [[runGoalCommand()]] `EXTRACTED`
- [[runRevertCommand()]] `EXTRACTED`
- [[updateSession()]] `INFERRED`
- [[persistSession()]] `EXTRACTED`
- [[openSkillPicker()]] `EXTRACTED`
- [[withEnvBlock()]] `INFERRED`
- [[addInfoRow()]] `EXTRACTED`
- [[showError()]] `EXTRACTED`
- [[clearTodos()]] `INFERRED`
- [[setGoalBoth()]] `EXTRACTED`
- [[buildContextText()]] `EXTRACTED`
